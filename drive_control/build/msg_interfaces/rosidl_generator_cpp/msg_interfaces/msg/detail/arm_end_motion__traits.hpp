...
#ifndef MSG_INTERFACES__MSG__DETAIL__ARM_END_MOTION__TRAITS_HPP_
#define MSG_INTERFACES__MSG__DETAIL__ARM_END_MOTION__TRAITS_HPP_
...
inline void to_yaml(
  const msg_interfaces::msg::ArmEndMotion & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const msg_interfaces::msg::ArmEndMotion & msg)
{
  return msg_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<msg_interfaces::msg::ArmEndMotion>()
{
  return "msg_interfaces::msg::ArmEndMotion";
}

template<>
inline const char * name<msg_interfaces::msg::ArmEndMotion>()
{
  return "msg_interfaces/msg/ArmEndMotion";
}

template<>
struct has_fixed_size<msg_interfaces::msg::ArmEndMotion>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<msg_interfaces::msg::ArmEndMotion>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<msg_interfaces::msg::ArmEndMotion>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MSG_INTERFACES__MSG__DETAIL__ARM_END_MOTION__TRAITS_HPP_
