...
static rosidl_typesupport_introspection_c__MessageMember msg_interfaces__msg__ArmEndMotion__rosidl_typesupport_introspection_c__ArmEndMotion_message_member_array[3] = {
  {
    "direction",  // name
