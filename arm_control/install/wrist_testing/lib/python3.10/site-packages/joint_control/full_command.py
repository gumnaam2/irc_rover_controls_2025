...
class JoystickControlNode(Node):
    ...
    def joystick_callback(self, joystick):
        ...
        self.arm_command.speed = [self.joint2_speed, self.joint3_speed, self.base_speed, self.left_motor_speed, self.right_motor_speed, self.gripper_state] # change this according to position corresponding to address of joint2
        self.arm_command.direction = [self.joint2_direction, self.joint3_direction, self.base_direction, self.left_motor_direction, self.right_motor_direction, 0]
